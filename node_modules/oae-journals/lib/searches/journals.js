...
var Telemetry = require('oae-telemetry').telemetry('search-journals');

var SearchUtil = require('oae-search/lib/util');

/**
 * General search that searches a 'journals' analyzed field on content, scoping it by user access.
 *
...
module.exports = function(ctx, opts, callback) {
    ...
    var query = {
        'bool': {
            'should': [
                SearchUtil.createQueryStringQuery(opts.q, null, null)
            ],
    ...
    return callback(null, SearchUtil.createQuery(query, null, opts));
};
