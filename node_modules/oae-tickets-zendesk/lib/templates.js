 ...
 * @api private
 */
var zendeskTicketBodyTemplate = exports.zendeskTicketBodyTemplate = _.template([
    'Open Access enquiry <%= oaeTicket.externalId %> has been received by <%= tenant.displayName %> (https://<%= tenant.host %>/).',
    '',
    ...
    '  funders: <%= publication.funders || \'(none provided)\'%>',
    '  other funder(s): <%= publication.otherFunders || \'(none provided)\'%>',
