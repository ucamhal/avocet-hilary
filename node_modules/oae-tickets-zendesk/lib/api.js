...
var Templates = require('oae-tickets-zendesk/lib/templates');
var Zendesk = require('oae-tickets-zendesk/lib/internal/zendesk');

// A side effect of importing this module is to bind our event handler for the
// CREATED_TICKET event.
...
var TicketsZendeskAPI = exports.TicketsZendeskAPI = function TicketsZendeskAPI(options) {
    ...
    var principalsapi = options.principalsapi || PrincipalsAPI;
    ...
    that.createZendeskTicket = function(ctx, oaeTicket, callback) {
        ...
        // with the ticket.
        var user = principalsapi.getUser(ctx, oaeTicket.createdBy, function(err, user) {
    ...
    that._getOrCreateZendeskUser = function(client, name, email, callback) {
        ...
        validator.check(email, {'code': 400, 'msg': 'Cannot search for an invalid email address'}).isEmail();
