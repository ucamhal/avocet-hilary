...
var createZenDeskTicket = module.exports.createZenDeskTicket = function(ctx, user, tenant, ticket, callback) {
    ...
    PrincipalsDAO.getPrincipal(ticket.createdBy, function(err, user) {
        ...
        PublicationsAPI.getPublication(ctx, ticket.publicationId, function(err, publication) {
            ...
            // Contact the submitter at the address provided in the form, or
            // their account email if no address was provided.
                ...
                var zenDeskTicket = {
                    'ticket': {
                        ...
                        'description': ZenDeskTemplates.zendeskTicketBodyTemplate({
                            ...
                            'otherFunder': _getOtherFunder(publication.funders),
                            'ticket': ticket,
                            'groupID': groupID,
 ...
 * @return A string representing the timestamp's value
 */
 ...
 * @return The portion of the string after other:, or undefined if the string didn't start with other: or the string following other: was empty
 */
...
/**
 * Get the value of the first 'other:' funder in a list of funders.
 *
 * @param  {String[]}   funders     An array of funder strings
 * @return The value of the first 'Other' funder in the array
 */
var _getOtherFunder = function(funders) {
    return _.chain(funders).map(_stripOtherFunderPrefix).compact().first().value()
}
 ...
 *
 * @param  {String[]}   funders     An array of funder strings
 * @return A string representing the funder list
 */
