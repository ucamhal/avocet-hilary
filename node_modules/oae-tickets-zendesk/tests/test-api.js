...
describe('ZendeskTicketAPI', function() {
    ...
    describe('#createZendeskTicket()', function() {
        ...
        /**
         * Test that verifies that createZendeskTicket() should call tickets.create() with expected data.
         */
        it('should call tickets.create() with expected data', function(callback) {
            ...
            var api = new TicketsZendeskAPI.TicketsZendeskAPI({
                config: config,
                zendesk: zendesk,
                principalsapi: mockPrincipalsAPI,
    ...
    describe('#_getOrCreateZendeskUser()', function() {
        ...
        /**
         * Test that verifies that _getOrCreateZendeskUser() should create a new user if the user does not exist.
         */
        ...
        /**
         * Test that verifies that _getOrCreateZendeskUser() should return the existing user if one exists.
         */
