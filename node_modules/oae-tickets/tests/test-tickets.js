                ...
                describe('publication', function() {
                    ...
                    it('verify that a valid displayName has been entered', function(callback) {
                        ...
                        RestAPI.Content.createFile(camAdminRestContext, 'Some file', null, 'public', getFileStream, null, null, function(err, content) {
                            ...
                            var publication = _.extend(generatePublicationData(), {'displayName': ''});
                    ...
                    it('verify that a valid set of authors have been entered', function(callback) {
                        ...
                        RestAPI.Content.createFile(camAdminRestContext, 'Some file', null, 'public', getFileStream, null, null, function(err, content) {
                            ...
                            // Creating a ticket with invalid or missing 'authors'
                            var publication = _.extend(generatePublicationData(), {'authors': null});
                            TicketsRestAPI.createTicket(camAdminRestContext, {'contentId': content.id, 'sourceIds': generateRandomSourceId, 'publication': publication}, function(err, ticket) {
                                assert.strictEqual(err.code, 400);

                                // Creating a ticket with empty 'authors' should throw an error
                                publication = _.extend(generatePublicationData(), {'authors': {}});
                                TicketsRestAPI.createTicket(camAdminRestContext, {'contentId': content.id, 'sourceIds': generateRandomSourceId, 'publication': publication}, function(err, ticket) {
                                    assert.strictEqual(err.code, 400);
                    ...
                    it('verify that a valid journalName has been entered', function(callback) {
                        ...
                        RestAPI.Content.createFile(camAdminRestContext, 'Some file', null, 'public', getFileStream, null, null, function(err, content) {
                            ...
                            var publication = _.extend(generatePublicationData(), {'journalName': null});
                            TicketsRestAPI.createTicket(camAdminRestContext, {'contentId': content.id, 'sourceIds': generateRandomSourceId, 'publication': publication}, function(err, ticket) {
                                assert.strictEqual(err.code, 400);
                                return callback();
                            });
                    ...
                    it('verify that a valid publisher has been entered', function(callback) {
                        ...
                        RestAPI.Content.createFile(camAdminRestContext, 'Some file', null, 'public', getFileStream, null, null, function(err, content) {
                            ...
                            var publication = _.extend(generatePublicationData(), {'publisher': null});
                            TicketsRestAPI.createTicket(camAdminRestContext, {'contentId': content.id, 'sourceIds': generateRandomSourceId, 'publication': publication}, function(err, ticket) {
                                assert.strictEqual(err.code, 400);
                                return callback();
                            });
                    ...
                    it('verify that a valid acceptanceDate has been entered', function(callback) {
                        ...
                        RestAPI.Content.createFile(camAdminRestContext, 'Some file', null, 'public', getFileStream, null, null, function(err, content) {
                            ...
                            var publication = _.extend(generatePublicationData(), {'acceptanceDate': 'invalid_format'});
                            TicketsRestAPI.createTicket(camAdminRestContext, {'contentId': content.id, 'sourceIds': generateRandomSourceId, 'publication': publication}, function(err, ticket) {
                                assert.strictEqual(err.code, 400);
                                return callback();
                            });
                    ...
                    it('verify that a valid date has been entered', function(callback) {
                        ...
                        RestAPI.Content.createFile(camAdminRestContext, 'Some file', null, 'public', getFileStream, null, null, function(err, content) {
                            ...
                            var publication = _.extend(generatePublicationData(), {'date': 'invalid_format'});
                            TicketsRestAPI.createTicket(camAdminRestContext, {'contentId': content.id, 'sourceIds': generateRandomSourceId, 'publication': publication}, function(err, ticket) {
                                assert.strictEqual(err.code, 400);
                                return callback();
                            });
                    ...
                    it('verify that a valid contactEmail has been entered', function(callback) {
                        ...
                        RestAPI.Content.createFile(camAdminRestContext, 'Some file', null, 'public', getFileStream, null, null, function(err, content) {
                            ...
                            var publication = _.extend(generatePublicationData(), {'contactEmail': null});
                            TicketsRestAPI.createTicket(camAdminRestContext, {'contentId': content.id, 'sourceIds': generateRandomSourceId, 'publication': publication}, function(err, ticket) {
                                assert.strictEqual(err.code, 400);

                                // Creating a ticket with an invalid or missing 'contactEmail'
                                publication = _.extend(generatePublicationData(), {'contactEmail': 'invalid_format'});
                                TicketsRestAPI.createTicket(camAdminRestContext, {'contentId': content.id, 'sourceIds': generateRandomSourceId, 'publication': publication}, function(err, ticket) {
                                    assert.strictEqual(err.code, 400);
                                    return callback();
                                });
                    ...
                    it('verify that a valid publicationType has been entered', function(callback) {
                        ...
                        RestAPI.Content.createFile(camAdminRestContext, 'Some file', null, 'public', getFileStream, null, null, function(err, content) {
                            ...
                            var publication = _.extend(generatePublicationData(), {'publicationType': null});
                            TicketsRestAPI.createTicket(camAdminRestContext, {'contentId': content.id, 'sourceIds': generateRandomSourceId, 'publication': publication}, function(err, ticket) {
                                assert.strictEqual(err.code, 400);
                                return callback();
                            });
                    ...
                    it('verify that a valid value for useCambridgeAddendum has been entered', function(callback) {
                        ...
                        RestAPI.Content.createFile(camAdminRestContext, 'Some file', null, 'public', getFileStream, null, null, function(err, content) {
                            ...
                            // Creating a ticket with an invalid or missing value for 'useCambridgeAddendum'
                            var publication = _.extend(generatePublicationData(), {'useCambridgeAddendum': null});
                            TicketsRestAPI.createTicket(camAdminRestContext, {'contentId': content.id, 'sourceIds': generateRandomSourceId, 'publication': publication}, function(err, ticket) {
                                assert.strictEqual(err.code, 400);
                                return callback();
                            });
                        ...
                        TestsUtil.createTenantWithAdmin(tenantAlias, tenantAlias, function(err, tenant, tenantAdminRestContext) {
                            ...
                            TestsUtil.generateTestUsers(tenantAdminRestContext, 1, function(err, users, camUser) {
                                ...
                                RestAPI.Content.createFile(camUser.restContext, 'Some file', null, 'public', getFileStream, null, null, function(err, content) {
                                    ...
                                    // Create a new ticket
                                    var publication = _.extend(generatePublicationData(), {'underEmbargo': true});
