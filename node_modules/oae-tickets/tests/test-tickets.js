...
describe('Tickets', function() {
     ...
     */
    var generatePublicationData = function() {
        return {
            'displayName': TestsUtil.generateRandomText(),
            'authors': [_.sample(['author A', 'author B'])],
            'institution': TestsUtil.generateRandomText(),
            'department': TestsUtil.generateRandomText(),
            'journalName': TestsUtil.generateRandomText(),
            'publisher': TestsUtil.generateRandomText(),
            'acceptanceDate': Date.now(),
            'funders': [_.sample(['funder A', 'funder B'])],
            'date': Date.now(),
            'contactEmail': util.format('%s@openaccess.cam.ac.uk', TestsUtil.generateRandomText()),
            'publicationType': _.sample(['book', 'chapter', 'composition', 'dataset']),
            'useCambridgeAddendum': _.sample(['true', 'false']),
            'openAccessType': _.sample(['gold', 'green']),
            'thumbnailUri': util.format('http://%s.com', TestsUtil.generateRandomText()),
        ...
        describe('#createTicket()', function() {
            ...
            describe('verify parameters', function() {
                ...
                describe('publication', function() {
                    ...
                    /**
                     * Test that verifies that a valid displayName has been entered
                     */
                    it('verify that a valid displayName has been entered', function(callback) {
                        ...
                        RestAPI.Content.createFile(camAdminRestContext, 'Some file', null, 'public', getFileStream, null, null, function(err, content) {
                            ...
                            // Creating a ticket with an invalid or missing 'displayName'
                            var publication = {
                                'displayName': ''
                            };
                    ...
                    /**
                     * Test that verifies that valid authors have been entered
                     */
                    it('verify that a valid set of authors have been entered', function(callback) {
                        ...
                        RestAPI.Content.createFile(camAdminRestContext, 'Some file', null, 'public', getFileStream, null, null, function(err, content) {
                            ...
                            TicketsRestAPI.createTicket(camAdminRestContext, {'contentId': content.id, 'sourceIds': generateRandomSourceId, 'publication': publication}, function(err, ticket) {
                                ...
                                // Creating a ticket with empty 'authors' should throw an error
                                var publication = {
                                    'displayName': 'Some displayName',
                                    'authors': {}
                                };
                    ...
                    /**
                     * Test that verifies that a valid journalName has been entered
                     */
                    it('verify that a valid journalName has been entered', function(callback) {
                        ...
                        RestAPI.Content.createFile(camAdminRestContext, 'Some file', null, 'public', getFileStream, null, null, function(err, content) {
                            ...
                            // Creating a ticket with an invalid or missing 'journalName'
                            var publication = {
                                'displayName': 'Some displayName',
                    ...
                    /**
                     * Test that verifies that a valid publisher has been entered
                     */
                    it('verify that a valid publisher has been entered', function(callback) {
                        ...
                        RestAPI.Content.createFile(camAdminRestContext, 'Some file', null, 'public', getFileStream, null, null, function(err, content) {
                            ...
                            // Creating a ticket with an invalid or missing 'publisher'
                            var publication = {
                                'displayName': 'Some displayName',
                                'authors': ['author A', 'author B'],
                    ...
                    /**
                     * Test that verifies that a valid acceptanceDate has been entered
                     */
                    it('verify that a valid acceptanceDate has been entered', function(callback) {
                        ...
                        RestAPI.Content.createFile(camAdminRestContext, 'Some file', null, 'public', getFileStream, null, null, function(err, content) {
                            ...
                            // Creating a ticket with an invalid or missing 'acceptanceDate'
                            var publication = {
                                'displayName': 'Some displayName',
                                'authors': ['author A', 'author B'],
                                'journalName': 'Some journal',
                            ...
                            TicketsRestAPI.createTicket(camAdminRestContext, {'contentId': content.id, 'sourceIds': generateRandomSourceId, 'publication': publication}, function(err, ticket) {
                                ...
                                // Creating a ticket with an invalid or missing 'date'
                                var publication = {
                                    'displayName': 'Some displayName',
                                    'authors': ['author A', 'author B'],
                                    'journalName': 'Some journal',
                    ...
                    /**
                     * Test that verifies that valid funders have been entered
                     */
                    it('verify that a valid set of funders have been entered', function(callback) {

                        // Create a new content item
                        RestAPI.Content.createFile(camAdminRestContext, 'Some file', null, 'public', getFileStream, null, null, function(err, content) {
                            assert.ok(!err);

                            // Creating a ticket with invalid or missing 'funders'
                            var publication = {
                                'displayName': 'Some displayName',
                                'authors': ['author A', 'author B'],
                                'journalName': 'Some journal',
                            ...
                            TicketsRestAPI.createTicket(camAdminRestContext, {'contentId': content.id, 'sourceIds': generateRandomSourceId, 'publication': publication}, function(err, ticket) {
                                ...
                                // Creating a ticket with empty 'funders' should throw an error
                                var publication = {
                                    'displayName': 'Some displayName',
                                    'authors': ['author A', 'author B'],
                                    'journalName': 'Some journal',
                                ...
                                TicketsRestAPI.createTicket(camAdminRestContext, {'contentId': content.id, 'sourceIds': generateRandomSourceId, 'publication': publication}, function(err, ticket) {
                                    assert.strictEqual(err.code, 400);
                                    assert.strictEqual(err.msg, 'Missing funders');
                    ...
                    /**
                     * Test that verifies that a valid date has been entered
                     */
                    ...
                    /**
                     * Test that verifies that a valid contactEmail has been entered
                     */
                    it('verify that a valid contactEmail has been entered', function(callback) {
                        ...
                        RestAPI.Content.createFile(camAdminRestContext, 'Some file', null, 'public', getFileStream, null, null, function(err, content) {
                            ...
                            // Creating a ticket with an invalid or missing 'contactEmail'
                            var publication = {
                                'displayName': 'Some displayName',
                                'authors': ['author A', 'author B'],
                                'journalName': 'Some journal',
                    ...
                    /**
                     * Test that verifies that a valid publicationType has been entered
                     */
                    it('verify that a valid publicationType has been entered', function(callback) {
                        ...
                        RestAPI.Content.createFile(camAdminRestContext, 'Some file', null, 'public', getFileStream, null, null, function(err, content) {
                            ...
                            // Creating a ticket with an invalid or missing 'publicationType'
                            var publication = {
                                'displayName': 'Some displayName',
                                'authors': ['author A', 'author B'],
                                'journalName': 'Some journal',
                    ...
                    /**
                     * Test that verifies that a valid value for useCambridgeAddendum has been entered
                     */
                    it('verify that a valid value for useCambridgeAddendum has been entered', function(callback) {
                        ...
                        RestAPI.Content.createFile(camAdminRestContext, 'Some file', null, 'public', getFileStream, null, null, function(err, content) {
                            ...
                            // Creating a ticket with an invalid or missing 'useCambridgeAddendum'
                            var publication = {
                                'displayName': 'Some displayName',
                                'authors': ['author A', 'author B'],
                                'journalName': 'Some journal',
                     ...
                     */
                    it('TODO: verify that a publication can only have one ticket', function(callback) {
                        ...
                        TestsUtil.createTenantWithAdmin(tenantAlias, tenantAlias, function(err, tenant, tenantAdminRestContext) {
                            ...
                            TestsUtil.generateTestUsers(tenantAdminRestContext, 1, function(err, users, camUser) {
                                ...
                                RestAPI.Content.createFile(camUser.restContext, 'Some file', null, 'public', getFileStream, null, null, function(err, content) {
                                    ...
                                    // Create a new ticket
                                    TicketsRestAPI.createTicket(camUser.restContext, {'contentId': content.id, 'sourceIds': generateRandomSourceId, 'publication': generatePublicationData}, function(err, ticket) {
                                        assert.ok(!err);
                ...
                it('verify that only authorized users are allowed to create tickets', function(callback) {
                    TestsUtil.generateTestUsers(camAdminRestContext, 2, function(err, users, coenegoUser, simongUser) {
                        ...
                        RestAPI.Content.createFile(camAdminRestContext, 'Some file', null, 'public', getFileStream, null, null, function(err, content) {
                            ...
                            TicketsRestAPI.createTicket(anonymousRestContext, {'contentId': content.id, 'sourceIds': generateRandomSourceId}, function(err, ticket) {
                                assert.strictEqual(err.code, 401);

                                // Creating a ticket with a regular user who is NOT the creator of the content item should throw an error
                                TicketsRestAPI.createTicket(simongUser.restContext, {'contentId': content.id, 'sourceIds': generateRandomSourceId}, function(err, ticket) {
                                    assert.strictEqual(err.code, 401);

                                    // Creating a ticket with a admin from another tenant than the tenant of the content item should thrown an error
                                    TicketsRestAPI.createTicket(gtAdminRestContext, {'contentId': content.id, 'sourceIds': generateRandomSourceId}, function(err, ticket) {
                                        assert.strictEqual(err.code, 401);
                                        return callback();
                                    });
                                });
            ...
            describe('verify parameters', function() {
                ...
                it('verify ticketId', function(callback) {
                    ...
                    TicketsAPI.updateTicket(null, {}, function(err, ticket) {
                        ...
                        TicketsAPI.updateTicket('malformed_ticket_id', {}, function(err, ticket) {
                            assert.strictEqual(err.code, 400);

                            // Updating an unexisting ticket should throw an error
                            TicketsAPI.updateTicket('t:camtest:0123456789', {}, function(err, ticket) {
                                assert.strictEqual(err.code, 404);
                                return callback();
                            });
                        });
                ...
                it('verify update parameters', function(callback) {
                    ...
                    RestAPI.Content.createFile(coenegoUser.restContext, 'Some file', null, 'public', getFileStream, null, null, function(err, content) {
                        ...
                        TicketsRestAPI.createTicket(coenegoUser.restContext, {'contentId': content.id, 'sourceIds': generateRandomSourceId, 'publication': generatePublicationData}, function(err, ticket) {
                            ...
                            TicketsAPI.updateTicket(createdTicket.id, null, function(err, ticket) {
                                assert.strictEqual(err.code, 400);

                                // Updating a ticket while passing in empty update parameters object should throw an error
                                TicketsAPI.updateTicket(createdTicket.id, {}, function(err, ticket) {
                                    assert.strictEqual(err.code, 400);

                                    // Updating a ticket while passing in invalid update parameters should throw an error
                                    TicketsAPI.updateTicket(createdTicket.id, {'foo': 'bar'}, function(err, ticket) {
                                        assert.strictEqual(err.code, 400);
                                        return callback();
                                    });
                                });
            ...
            it('verify that requesting a set of publications come with their corresponding ticket', function(callback) {
                ...
                TestsUtil.generateTestUsers(camAdminRestContext, 1, function(err, users, camUser) {
                    ...
                    RestAPI.Content.createFile(camUser.restContext, 'Some file', null, 'public', getFileStream, null, null, function(err, content) {
                        ...
                        var publication = generatePublicationData();
                        publication = _.extend(publication, {'authors': [camUser.user.id, 'author B', 'author C']});
                        TicketsRestAPI.createTicket(camUser.restContext, {'contentId': content.id, 'sourceIds': generateRandomSourceId, 'publication': publication}, function(err, ticket) {
                            ...
                            RestAPI.Content.createFile(camUser.restContext, 'Some file', null, 'public', getFileStream, null, null, function(err, content) {
                                ...
                                var publication = generatePublicationData();
                                publication = _.extend(publication, {'authors': ['author A', 'author B']});
                                TicketsRestAPI.createTicket(camUser.restContext, {'contentId': content.id, 'sourceIds': generateRandomSourceId, 'publication': publication}, function(err, ticket) {
                                    assert.ok(!err);
                                    assert.ok(ticket.publication);
                                    assert.strictEqual(ticket.publication.linkedContentId, content.id);
            ...
            it('verify that requesting a set of publications come with their corresponding ticket for authorized users only', function(callback) {
                ...
                TestsUtil.generateTestUsers(camAdminRestContext, 2, function(err, users, camUserA, camUserB) {
                    ...
                    RestAPI.Content.createFile(camUserA.restContext, 'Some file', null, 'public', getFileStream, null, null, function(err, content) {
                        ...
                        // Create a first ticket
                        var publication = generatePublicationData();
                        publication = _.extend(publication, {'authors': [camUserA.user.id, 'author B', 'author C']});
