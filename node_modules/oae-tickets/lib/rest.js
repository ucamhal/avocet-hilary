...
OAE.tenantRouter.on('post', '/api/ticket/create', function(req, res) {
    ...
    if (req.body.publication) {
        ...
        var date = OaeUtil.getNumberParam(req.body.publication.date, req.body.publication.date || null);
        var acceptanceDate = OaeUtil.getNumberParam(req.body.publication.acceptanceDate, req.body.publication.acceptanceDate || null);
        // Default the publication to be under an indefinite emabargo
