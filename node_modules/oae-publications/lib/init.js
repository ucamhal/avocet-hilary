...
var ensureSchema = function(callback) {
    Cassandra.createColumnFamilies({
        ...
        'Publications': 'CREATE TABLE "Publications" ("publicationId" text PRIMARY KEY, "createdBy" text, "displayName" text, "publicationType" text, "date" bigint, "linkedContentId" text, "thumbnailUri" text, "publisher" text, "openAccessType" text, "issueNumber" text, "pageBegin" text, "pageEnd" text)',
