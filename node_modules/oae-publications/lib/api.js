...
IngesterAPI.ingestPublication = function(tenantAlias, publication, sourceIds, callback) {
    ...
    if (_.isObject(publication)) {
        ...
        // Ensure that the acceptanceDate is an int if it's present
        if (publication.acceptanceDate) {
            validator.check(publication.acceptanceDate, {'code': 400, 'msg': 'The publication acceptanceDate is malformed'}).isInt();
        }
    }
    // Verify the sources
