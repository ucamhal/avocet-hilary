...
var getPublication = module.exports.getPublication = function(ctx, publicationId, callback) {
    ...
    canManage(ctx, publicationId, function(err, canManage, publication) {
        if (err) {
            ...
            return callback({'code': 401, 'msg': 'You are not allowed to view this piece of content'});
        }
...
var _canManage = function(ctx, publication) {
    ...
    // If the user created the publication he is allowed to manage it
    if (contextUser.id === publication.createdBy) {
        return true;
    }
