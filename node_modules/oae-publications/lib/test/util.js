...
var getAllPublicationsForUser = module.exports.getAllPublicationsForUser = function(restContext, userId, callback, _publications, _nextToken) {
    ...
    getPublicationsByAuthor(restContext, userId, _nextToken, 25, function(err, data) {
        if (err) {
            return callback(err);
        }
 ...
 */
var getPublicationsByAuthor = module.exports.getPublicationsByAuthor = function(restCtx, userId, start, limit, callback) {
    var params = {
        'start': start,
        'limit': limit
    };
