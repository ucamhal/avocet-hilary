...
var createPublication = function(req, res) {
    ...
    var publication = new Publication(null, null, req.body.displayName, req.body.publicationType, req.body.date, req.body.thumbnailUri, authors, req.body.publisher, {
