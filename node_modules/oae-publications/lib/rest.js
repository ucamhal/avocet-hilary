...
OAE.globalAdminRouter.on('get', '/api/publications/:publicationId', getPublication);
...
OAE.globalAdminRouter.on('get', '/api/publications/library/:userId', getPublicationsByAuthor);
...
OAE.globalAdminRouter.on('get', '/api/publications/uploads/:userId', getPublicationsByCreator);
OAE.tenantRouter.on('get', '/api/publications/uploads/:userId', getPublicationsByCreator);
...
var createPublication = function(req, res) {
    ...
    var publication = new Publication(null, userId, null, req.body.displayName, req.body.publicationType, req.body.date, req.body.thumbnailUri, authors, req.body.publisher, {
...
OAE.globalAdminRouter.on('post', '/api/publications/:publicationId/update', updatePublication);
OAE.tenantRouter.on('post', '/api/publications/:publicationId/update', updatePublication);
