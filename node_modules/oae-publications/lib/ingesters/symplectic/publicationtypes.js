...
var Artefact = function(entry, authorName) {
    ...
    var publication = new Publication(null, null, displayName, PublicationsConstants.publicationTypes.ARTEFACT, date);
...
var Book = function(entry, authorName) {
    ...
    var publication = new Publication(null, null, displayName, PublicationsConstants.publicationTypes.BOOK, date, null, authors, publisher, extra);
    return new IngesterPublication(authorName, sourceIds, publication);
};
...
var Chapter = function(entry, authorName) {
    ...
    var publication = new Publication(null, null, displayName, PublicationsConstants.publicationTypes.CHAPTER, date, null, authors, publisher, extra);
    return new IngesterPublication(authorName, sourceIds, publication);
};
...
var Conference = function(entry, authorName) {
    ...
    var publication = new Publication(null, null, displayName, PublicationsConstants.publicationTypes.CONFERENCE, date, null, authors, publisher, extra);
    return new IngesterPublication(authorName, sourceIds, publication);
};
...
var JournalArtical = function(entry, authorName) {
    ...
    var publication = new Publication(null, null, displayName, PublicationsConstants.publicationTypes.JOURNAL_ARTICLE, date, null, authors, publisher, extra);
    return new IngesterPublication(authorName, sourceIds, publication);
};
...
var Report = function(entry, authorName) {
    ...
    var publication = new Publication(null, null, displayName, PublicationsConstants.publicationTypes.REPORT, date, null, authors, publisher, extra);
    return new IngesterPublication(authorName, sourceIds, publication);
};
...
var Thesis = function(entry, authorName) {
    ...
    var extra = {};
    var publication = new Publication(null, null, displayName, PublicationsConstants.publicationTypes.THESIS, date, null, authors, publisher, extra);
    return new IngesterPublication(authorName, sourceIds, publication);
};
