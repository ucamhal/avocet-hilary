 ...
 * @param  {String}         [extra.institution]             The author's institution (e.g. University of Cambridge). (Optional, not used in Symplectic)
 * @param  {String}         [extra.department]              The affiliated department (e.g. Department of Classics). (Optional, not used in Symplectic)
