...
var Publication = module.exports.Publication = function(id, tenantAlias, createdBy, linkedContentId, displayName, publicationType, date, thumbnailUri, authors, publisher, extra) {
    ...
    that.journalName = extra.journalName || null;
    that.issueNumber = extra.issueNumber || null;
    that.pageBegin = extra.pageBegin || null;
    that.pageEnd = extra.pageEnd || null;
    that.acceptanceDate = extra.acceptanceDate || null;

    that.funders = extra.funders || null;

    that.department = extra.department || null;
    that.contactEmail = extra.contactEmail || null;
    that.useCambridgeAddendum = extra.useCambridgeAddendum || null;

    that.comments = extra.comments || null;
