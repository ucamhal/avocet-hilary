...
describe('Publications', function() {
    ...
    describe('#createPublication()', function() {
        ...
        it('verify extra parameters', function(callback) {
            ...
            RestAPI.Publications.createPublication(camAdminRestCtx, [generateRandomSourceId], 'displayName', 'journal article', 1388676959000, ['an author'], extra, getFileStream, function(err, data) {
                assert.ok(!err);
                ...
                RestAPI.Publications.getPublication(camAdminRestCtx, data.publication.id, function(err, publication) {
                    ...
                    // Create a new publication
                    RestAPI.Publications.createPublication(camAdminRestCtx, [generateRandomSourceId], 'Some publication', 'journal article', 1388676959000, ['an author'], extra, getFileStream, function(err, data) {
                        assert.ok(!err);
                        assert.ok(data.publication);
