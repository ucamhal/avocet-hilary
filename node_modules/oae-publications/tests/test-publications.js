    ...
    var createUserWithPublications = function(nrOfPublications, callback) {
        TestsUtil.generateTestUsers(camAdminRestCtx, 1, function(err, users, createdUser) {
            ...
            var _createPublications = function() {
                ...
                var publication = new Publication(null, 'camtest', null, null, 'displayName', 'journal article', publishedDate, null, [createdUser.user.displayName], 'publisher', {
                    ...
                    RestAPI.Content.createFile(coenego.restContext, 'paper.pdf', null, 'public', getFileStream, null, null, function(err, content) {
                        ...
                        PublicationsAPI.createPublication('camtest', [ generateRandomSourceId() ], publication, function(err, publication, result) {
                            ...
                            PublicationsRestAPI.getPublicationsByAuthor(coenego.restContext, coenego.user.id, null, 50, function(err, data) {
                                ...
                                assert.strictEqual(data.results[0].linkedContent.displayName, publication.displayName);
                    ...
                    PublicationsAPI.createPublication('camtest', [ generateRandomSourceId() ], publication, function(err, publication, result) {
                        ...
                        PublicationsAPI.createPublication('camtest', [ generateRandomSourceId() ], publication, function(err, publication, result) {
                            ...
                            PublicationsRestAPI.getPublicationsByAuthor(coenego.restContext, coenego.user.id, null, null, function(err, data) {
                                ...
                                assert.strictEqual(data.results[0].id, createdPublication1.id);
                                assert.strictEqual(data.results[0].authors.length, createdPublication1.authors.length);
                                assert.strictEqual(data.results[0].createdBy, createdPublication1.createdBy);
                                assert.strictEqual(data.results[0].date, createdPublication1.date);
                                assert.strictEqual(data.results[0].displayName, createdPublication1.displayName);
                                assert.strictEqual(data.results[0].publicationType, createdPublication1.publicationType);

                                // Check the second publication
                                assert.strictEqual(data.results[1].id, createdPublication2.id);
                                assert.strictEqual(data.results[1].authors.length, createdPublication2.authors.length);
                                assert.strictEqual(data.results[1].createdBy, createdPublication2.createdBy);
                                assert.strictEqual(data.results[1].date, createdPublication2.date);
                                assert.strictEqual(data.results[1].displayName, createdPublication2.displayName);
                                assert.strictEqual(data.results[1].publicationType, createdPublication2.publicationType);
                                return callback();
                            });
                        });
                    });
