...
describe('Publications - Regular', function() {
    ...
    var createUserWithPublications = function(nrOfPublications, callback) {
        TestsUtil.generateTestUsers(camAdminRestCtx, 1, function(err, users, createdUser) {
            ...
            _.times(nrOfPublications, function(i) {
                ...
                RestAPI.Publications.createPublication(camAdminRestCtx, [ generateRandomSourceId() ], 'displayName', 'journal article', publishedDate, [createdUser.user.displayName], null, null, function(err, data) {
                    assert.ok(!err);
    ...
    describe('#createPublication()', function() {
        ...
        it('verify parameter validation', function(callback) {
            ...
            // Enable creating publications for tenant
            ConfigTestUtil.updateConfigAndWait(camAdminRestCtx, null, {'oae-publications/publications/allowUserEntry': true}, function(err) {
                ...
                RestAPI.Publications.createPublication(camAdminRestCtx, ['wos#1234'], null, 'journal article', 1388676959000, ['an author'], null, null, function(err, data) {
                    assert.equal(err.code, 400);
                    RestAPI.Publications.createPublication(camAdminRestCtx, ['wos#1234'], 'displayName', null, 1388676959000, ['an author'], null, null, function(err) {
                        assert.equal(err.code, 400);
                        RestAPI.Publications.createPublication(camAdminRestCtx, ['wos#1234'], 'displayName', 'unknown publication type', 1388676959000, ['an author'], null, null, function(err) {
                            assert.equal(err.code, 400);
                            RestAPI.Publications.createPublication(camAdminRestCtx, ['wos#1234'], 'displayName', 'journal article', null, ['an author'], null, null, function(err) {
                                assert.equal(err.code, 400);
                                RestAPI.Publications.createPublication(camAdminRestCtx, ['wos#1234'], 'displayName', 'journal article', 'not a date', ['an author'], null, null, function(err) {
                                    assert.equal(err.code, 400);
                                    RestAPI.Publications.createPublication(camAdminRestCtx, ['wos#1234'], 'displayName', 'journal article', 1388676959000, null, null, null, function(err) {
                                        assert.equal(err.code, 400);
                                        RestAPI.Publications.createPublication(camAdminRestCtx, ['wos#1234'], 'displayName', 'journal article', 1388676959000, {}, null, null, function(err) {
                                            ...
                                            RestAPI.Publications.createPublication(camAdminRestCtx, ['wos#1234'], 'displayName', 'journal article', 1388676959000, [], null, null, function(err) {
                                                ...
                                                RestAPI.Publications.createPublication(camAdminRestCtx, null, 'displayName', 'journal article', 1388676959000, ['an author'], null, null, function(err) {
                                                    assert.equal(err.code, 400);
                                                    RestAPI.Publications.createPublication(camAdminRestCtx, {}, 'displayName', 'journal article', 1388676959000, ['an author'], null, null, function(err) {
                                                        assert.equal(err.code, 400);
                                                        RestAPI.Publications.createPublication(camAdminRestCtx, [], 'displayName', 'journal article', 1388676959000, ['an author'], null, null, function(err) {
                                                            assert.equal(err.code, 400);
                                                            RestAPI.Publications.createPublication(camAdminRestCtx, ['not a source id'], 'displayName', 'journal article', 1388676959000, ['an author'], null, null, function(err) {
                                                                assert.equal(err.code, 400);

                                                                // Sanity check
                                                                RestAPI.Publications.createPublication(camAdminRestCtx, ['wos#1234'], 'displayName', 'journal article', 1388676959000, ['an author'], null, null, function(err) {
                                                                    assert.ok(!err);
                                                                    return callback();
                                                                });
                                                            });
        ...
        /**
         * Test that verifies only admins can create publications if the `allowUserEntry` is disabled
         */
        it('verify permissions', function(callback) {
            TestsUtil.generateTestUsers(camAdminRestCtx, 1, function(err, users, simong) {
                RestAPI.Publications.createPublication(camAnonymousRestCtx, [ generateRandomSourceId() ], 'displayName A', 'journal article', 1388676959000, ['Author from A'], null, null, function(err, dataA) {
                    assert.equal(err.code, 401);
                    RestAPI.Publications.createPublication(simong.restContext, [ generateRandomSourceId() ], 'displayName A', 'journal article', 1388676959000, ['Author from A'], null, null, function(err, dataA) {
                        assert.equal(err.code, 401);

                        // Admins can always create publications
                        RestAPI.Publications.createPublication(camAdminRestCtx, [ generateRandomSourceId() ], 'displayName A', 'journal article', 1388676959000, ['Author from A'], null, null, function(err, dataA) {
                            assert.ok(!err);
                            RestAPI.Admin.loginOnTenant(TestsUtil.createGlobalAdminRestContext(), 'localhost', function(err, ctx) {
                                assert.ok(!err);
                                RestAPI.Publications.createPublication(ctx, [ generateRandomSourceId() ], 'displayName A', 'journal article', 1388676959000, ['Author from A'], null, null, function(err, dataA) {
                                    assert.ok(!err);
        ...
        it('verify ingesting a publication with an already seen source results in an update', function(callback) {
            ...
            RestAPI.Publications.createPublication(camAdminRestCtx, sourceIdsA, 'displayName A', 'journal article', 1388676959000, ['Author from A'], null, null, function(err, dataA) {
                assert.ok(!err);
                ...
                RestAPI.Publications.createPublication(camAdminRestCtx, sourceIdsA, 'displayName B', 'journal article', 1388676959000, ['Author from B'], null, null, function(err, dataB) {
                    assert.ok(!err);
        ...
        it('verify functionality', function(callback) {
            ...
            RestAPI.Publications.createPublication(camAdminRestCtx, [generateRandomSourceId()], 'A displayName', 'journal article', 1388676959000, ['An author'], extra, null, function(err, data) {
                assert.ok(!err);

                // Get the full publication and asser that all the data is returned
                RestAPI.Publications.getPublication(camAdminRestCtx, data.publication.id, function(err, publication) {
                    assert.ok(!err);
        ...
        it('verify attaching a resource while creating a publication is successful', function(callback) {
            TestsUtil.generateTestUsers(camAdminRestCtx, 1, function(err, users, coenego) {
                ...
                ConfigTestUtil.updateConfigAndWait(camAdminRestCtx, null, {'oae-publications/publications/allowUserEntry': true}, function(err) {
                    ...
                    var file = getFileStream();
                    RestAPI.Publications.createPublication(coenego.restContext, [generateRandomSourceId()], 'displayName A', 'journal article', date, authors, null, file, function(err, data) {
                        assert.ok(!err);
                        ...
                        assert.equal(data.publication.authors[0], authors[0]);
                        assert.equal(data.publication.authors[1], authors[1]);
                        assert.equal(data.publication.authors[2], authors[2]);
                        assert.equal(data.publication.authors.length, authors.length);
    ...
    describe('#linkPublicationToUser()', function() {
        ...
        it('verify parameter validation', function(callback) {
            TestsUtil.generateTestUsers(camAdminRestCtx, 1, function(err, users, simong) {
                ...
                // Create a new publication
                RestAPI.Publications.createPublication(camAdminRestCtx, [ generateRandomSourceId() ], 'displayName A', 'journal article', 1388676959000, ['someAuthor'], null, null, function(err, data) {
                    assert.ok(!err);
        ...
        it('verify permissions', function(callback) {
            TestsUtil.generateTestUsers(camAdminRestCtx, 2, function(err, users, simong, mrvisser) {
                RestAPI.Publications.createPublication(camAdminRestCtx, [ generateRandomSourceId() ], 'displayName A', 'journal article', 1388676959000, ['authorA', 'authorB'], null, null, function(err, data) {
                    assert.ok(!err);
        ...
        it('verify linking authors with registered oae users', function(callback) {
            TestsUtil.generateTestUsers(camAdminRestCtx, 1, function(err, users, coenego) {
                ...
                // Create a new publication
                RestAPI.Publications.createPublication(camAdminRestCtx, [ generateRandomSourceId() ], 'displayName A', 'journal article', 1388676959000, ['authorA', coenego.user.id], null, null, function(err, data) {
                    assert.ok(!err);
                    assert.strictEqual(data.publication.authors.length, 2);
                    assert.strictEqual(data.publication.authors[0], 'authorA');
                    assert.strictEqual(data.publication.authors[1], coenego.user.id);
            ...
            TestsUtil.generateTestUsers(camAdminRestCtx, 1, function(err, users, coenego) {
                ...
                ConfigTestUtil.updateConfigAndWait(camAdminRestCtx, null, {'oae-publications/publications/allowUserEntry': true}, function(err) {
                    ...
                    RestAPI.Publications.createPublication(coenego.restContext, [generateRandomSourceId()], 'displayName A', 'journal article', date, authors, null, file, function(err, data) {
                        ...
                        // Sanity check
                        RestAPI.Publications.getPublication(coenego.restContext, createdPublication.id, function(err, publication) {
                            assert.ok(!err);
            ...
            TestsUtil.generateTestUsers(camAdminRestCtx, 1, function(err, users, coenego) {
                ...
                ConfigTestUtil.updateConfigAndWait(camAdminRestCtx, null, {'oae-publications/publications/allowUserEntry': true}, function(err) {
                    ...
                    RestAPI.Publications.createPublication(coenego.restContext, [generateRandomSourceId()], 'displayName A', 'journal article', date, authors, null, file, function(err, data) {
                        ...
                        RestAPI.Publications.getPublications(coenego.restContext, coenego.user.id, null, 50, function(err, data) {
                            assert.ok(!err);
                            assert.ok(data);
            ...
            TestsUtil.generateTestUsers(camAdminRestCtx, 1, function(err, users, coenego) {
                ...
                ConfigTestUtil.updateConfigAndWait(camAdminRestCtx, null, {'oae-publications/publications/allowUserEntry': true}, function(err) {
                    ...
                    RestAPI.Publications.createPublication(coenego.restContext, [generateRandomSourceId()], 'displayName A', 'journal article', date, authors, null, file, function(err, data) {
                        ...
                        RestAPI.Publications.getPublications(coenego.restContext, coenego.user.id, null, null, function(err, data) {
                            assert.ok(!err);
                            assert.ok(data);
                            assert.equal(data.results.length, 1);
                            assert.equal(data.results[0].id, createdPublication.id);
            ...
            TestsUtil.generateTestUsers(camAdminRestCtx, 1, function(err, users, coenego) {
                ...
                ConfigTestUtil.updateConfigAndWait(camAdminRestCtx, null, {'oae-publications/publications/allowUserEntry': true}, function(err) {
                    ...
                    RestAPI.Publications.createPublication(coenego.restContext, [generateRandomSourceId()], 'displayName A', 'journal article', date, authors, null, file, function(err, data) {
                        ...
                        file = getFileStream();
                        RestAPI.Publications.createPublication(coenego.restContext, [generateRandomSourceId()], 'displayName B', 'book', date, authors, null, file, function(err, data) {
                            assert.ok(!err);
                            assert.equal(data.publication.createdBy, coenego.user.id);
                            assert.equal(data.result, PublicationsConstants.ingestionResult.CREATED);
            ...
            TestsUtil.generateTestUsers(camAdminRestCtx, 1, function(err, users, coenego) {
                ...
                ConfigTestUtil.updateConfigAndWait(camAdminRestCtx, null, {'oae-publications/publications/allowUserEntry': true}, function(err) {
                    ...
                    RestAPI.Publications.createPublication(coenego.restContext, [generateRandomSourceId()], 'displayName A', 'journal article', date, authors, null, file, function(err, data) {
                        ...
                        // Check if the coenego user has been linked to the publication
                        RestAPI.Publications.getPublicationsByCreator(coenego.restContext, coenego.user.id, null, null, function(err, data) {
                            assert.ok(!err);
                            assert.ok(data);
                            assert.equal(data.results.length, 1);
                            assert.equal(data.results[0].id, createdPublication.id);
    ...
    describe('#updatePublication()', function(callback) {
        ...
        it('verify parameter validation', function(callback) {
            createUserWithPublications(1, function(coenego, createdPublications) {
                ...
                RestAPI.Publications.updatePublication(coenego.restContext, 'Not a publication ID', {}, function(err, data) {
                    assert.equal(err.code, 400);

                    // Malformed fields
                    RestAPI.Publications.updatePublication(coenego.restContext, createdPublications[0].id, 'Malformed fields', function(err, data) {
                        assert.equal(err.code, 400);

                        // Malformed fields
                        RestAPI.Publications.updatePublication(coenego.restContext, createdPublications[0].id, {}, function(err, data) {
                            assert.equal(err.code, 400);
                            ...
                            RestAPI.Publications.updatePublication(coenego.restContext, createdPublications[0].id, [], function(err, data) {
                                ...
                                RestAPI.Publications.updatePublication(coenego.restContext, createdPublications[0].id, fields, function(err, data) {
                                    assert.ok(!err);
                                    return callback();
                                });
                            });
        ...
        it('verify permissions', function(callback) {
            createUserWithPublications(1, function(coenego, createdPublications) {
                ...
                var fields = {'displayName': 'A displayName'};
                RestAPI.Publications.updatePublication(camAnonymousRestCtx, createdPublications[0].id, fields, function(err, data) {
                    assert.equal(err.code, 401);

                    // Update the publication with an GT admin
                    RestAPI.Publications.updatePublication(gtAdminRestCtx, createdPublications[0].id, fields, function(err, data) {
                        assert.equal(err.code, 401);

                        // Update the publication with the Simong user
                        RestAPI.Publications.updatePublication(simongRestContext, createdPublications[0].id, fields, function(err, data) {
                            assert.equal(err.code, 401);
                            ...
                            RestAPI.Publications.updatePublication(coenego.restContext, createdPublications[0].id, fields, function(err, data) {
                                ...
                                RestAPI.Publications.updatePublication(camAdminRestCtx, createdPublications[0].id, fields, function(err, data) {
                                    assert.ok(!err);

                                    // Update the publication with an global admin
                                    RestAPI.Publications.updatePublication(globalAdminRestContext, createdPublications[0].id, fields, function(err, data) {
                                        assert.ok(!err);
                                        return callback();
                                    });
                                });
        ...
        it('verify updating a publication is successful', function(callback) {
            createUserWithPublications(1, function(coenego, createdPublications) {
                ...
                // Update the publication with a Cam admin
                var fields = {'displayName': 'A closed door is a happy door'};
                RestAPI.Publications.updatePublication(coenego.restContext, createdPublications[0].id, fields, function(err, data) {
                    assert.ok(!err);
                    assert.ok(data.publication);
                    assert.strictEqual(data.publication.id, createdPublications[0].id);
                    assert.strictEqual(data.publication.displayName, 'A closed door is a happy door');
                    ...
                    RestAPI.Publications.updatePublication(camAdminRestCtx, createdPublications[0].id, fields, function(err, data) {
                        ...
                        // Update the publication with an global admin
                        var fields = {'displayName': 'Another exotic display name that no one would ever use...'};
                        RestAPI.Publications.updatePublication(globalAdminRestContext, createdPublications[0].id, fields, function(err, data) {
                            assert.ok(!err);
                            assert.ok(data.publication);
                            assert.strictEqual(data.publication.id, createdPublications[0].id);
                            assert.strictEqual(data.publication.displayName, 'Another exotic display name that no one would ever use...');
                            assert.strictEqual(data.result, PublicationsConstants.ingestionResult.UPDATED);
                            return callback();
                        });
                    });
