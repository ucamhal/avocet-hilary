...
describe('Publications', function() {
    ...
    describe('#getPublication', function() {
        ...
        describe('verify get permissions', function() {
            it('verify anonymous users can\'t request publications', function(callback) {
                createPublication(function(err, publication) {
                    assert.ok(!err);
            ...
            it('verify logged in users can\'t request publications which aren\'t theirs', function(callback) {
                createUserWithPublications(1, function(ucamhal, createdPublications) {
                    var publication = createdPublications[0];
                    PublicationsRestAPI.getPublication(simongRestContext, publication.id, function(err, publication) {
                        assert.strictEqual(err.code, 401);
                        return callback();
                    });
                });
