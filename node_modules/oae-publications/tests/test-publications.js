...
describe('Publications - Regular', function() {
    ...
    before(function(callback) {
        ...
        TestsUtil.generateTestUsers(camAdminRestCtx, 1, function(err, users, simong) {
            ...
            // Enable the tickets module by default
            ConfigTestUtil.updateConfigAndWait(globalAdminRestCtx, null, {'oae-tickets/general/enabled': true}, function(err) {
                assert.ok(!err);
                return callback();
            });
        });
    ...
    /**
     * Make sure the module is disabled before running a test
     */
        ...
        TestsUtil.generateTestUsers(camAdminRestCtx, 1, function(err, users, createdUser) {
            ...
            var _createPublications = function() {
                ...
                RestAPI.Publications.createPublication(camAdminRestCtx, [ generateRandomSourceId() ], 'displayName', 'journal article', publishedDate, [createdUser.user.displayName], null, null, function(err, data) {
                    ...
                    RestAPI.Publications.linkPublicationToUser(camAdminRestCtx, data.publication.id, createdUser.user.displayName, createdUser.user.id, function(err) {
                        assert.ok(!err);
                        nrOfPublications--;
