    ...
    var createUserWithPublications = function(nrOfPublications, callback) {
        TestsUtil.generateTestUsers(camAdminRestCtx, 1, function(err, users, createdUser) {
            ...
            var _createPublications = function() {
                ...
                var publication = new Publication(null, 'camtest', null, null, 'displayName', 'journal article', publishedDate, null, [createdUser.user.displayName], null, {
                    'openAccessType': 'green',
                    'journalName': 'the journal name',
                    'issueNumber': '1',
                    'pageBegin': '10',
                    'pageEnd': '11',
                    'funders': ['funder a', 'funder b', 'funder c'],
                    'institution': 'the institution',
                    'department': 'the department',
                    'contactEmail': 'contact@mail.com',
                    'useCambridgeAddendum': 'true',
                    'comments': 'Lorem ipsum dolor sit amet',
                    'acceptanceDate': 1388676959000
                });
    ...
    describe('#createPublication()', function() {
        ...
        describe('verify parameters', function() {
            ...
            describe('verify publication', function() {
                ...
                /**
                 * Test that verifies that valid publication parameters have been specified
                 */
                it('verify that valid publication parameters have been specified', function(callback) {

                    // An invalid or missing displayName should return an error
                    var publication = {'displayName': null};
                    PublicationsAPI.createPublication('camtest', ['wos#1234'], publication, function(err, data) {
                        assert.strictEqual(err.code, 400);

                        // An invalid or missing publicationType should return an error
                        publication = {'displayName': 'displayName', 'publicationType': null};
                        PublicationsAPI.createPublication('camtest', ['wos#1234'], publication, function(err, data) {
                            assert.strictEqual(err.code, 400);

                            // An invalid or missing publicationType should return an error
                            publication = {'displayName': 'displayName', 'publicationType': 'unknown publication type'};
                            PublicationsAPI.createPublication('camtest', ['wos#1234'], publication, function(err, data) {
                                assert.strictEqual(err.code, 400);

                                // An invalid or missing date should return an error
                                publication = {'displayName': 'displayName', 'publicationType': 'other', 'date': null};
                                PublicationsAPI.createPublication('camtest', ['wos#1234'], publication, function(err, data) {
                                    assert.strictEqual(err.code, 400);

                                    // An invalid or missing date should return an error
                                    publication = {'displayName': 'displayName', 'publicationType': 'other', 'date': 'invalid format'};
                                    PublicationsAPI.createPublication('camtest', ['wos#1234'], publication, function(err, data) {
                                        assert.strictEqual(err.code, 400);

                                        // Invalid or missing authors should return an error
                                        publication = {'displayName': 'displayName', 'publicationType': 'other', 'date': 1388676959000, 'authors': null};
                                        PublicationsAPI.createPublication('camtest', ['wos#1234'], publication, function(err, data) {
                                            assert.strictEqual(err.code, 400);

                                            // Invalid or missing authors should return an error
                                            publication = {'displayName': 'displayName', 'publicationType': 'other', 'date': 1388676959000, 'authors': {}};
                                            PublicationsAPI.createPublication('camtest', ['wos#1234'], publication, function(err, data) {
                                                assert.strictEqual(err.code, 400);
        ...
        describe('creating publications', function() {
            ...
            it('verify that creating a publication is successful', function(callback) {
                ...
                var publication = {'displayName': 'displayName', 'publicationType': 'other', 'date': 1388676959000, 'authors': ['an author']};
                PublicationsAPI.createPublication('camtest', ['wos#1234'], publication, function(err, createdPublication) {
                    assert.ok(!err);
            ...
            it('verify that the extra parameters are persisted correctly', function(callback) {
                ...
                // Create a new publication
                var publication = new Publication(null, 'camtest', null, null, 'displayName', 'other', 1388676959000, null, ['an author'], null, {
                    'openAccessType': 'green',
                    'journalName': 'the journal name',
                    'issueNumber': '1',
                    'pageBegin': '10',
            ...
            it('verify ingesting a publication with an already seen source results in an update', function(callback) {
                ...
                var publication = new Publication(null, 'camtest', null, null, 'displayName A', 'journal article', 1388676959000, null, ['Author from A'], null, {
                    'openAccessType': 'green',
                    'journalName': 'the journal name',
                    'issueNumber': '1',
                    'pageBegin': '10',
                ...
                PublicationsAPI.createPublication('camtest', sourceIdsA, publication, function(err, publicationA, result) {
                    ...
                    assert.equal(result, PublicationsConstants.ingestionResult.CREATED);

                    // Because we have the same source as a source from A, we'll "update" the publication record
                    var publication = new Publication(null, 'camtest', null, null, 'displayName B', 'journal article', 1388676959000, null, ['Author from B'], null, {
                        'openAccessType': 'green',
                        'journalName': 'the journal name',
                        'issueNumber': '1',
                        'pageBegin': '10',
                    ...
                    PublicationsAPI.createPublication('camtest', sourceIdsA, publication, function(err, publicationB, result) {
                        ...
                        assert.equal(result, PublicationsConstants.ingestionResult.UPDATED);
                        assert.equal(publicationA.id, publicationB.id);
            ...
            it('verify that the content profile is added to the publication profile', function(callback) {
                TestsUtil.generateTestUsers(camAdminRestCtx, 1, function(err, users, coenegoUser) {
                    ...
                    RestAPI.Content.createFile(coenegoUser.restContext, 'paper.pdf', null, 'public', getFileStream, null, null, function(err, content) {
                        ...
                        // Create a new publication
                        var publication = new Publication(null, 'camtest', coenegoUser.user.id, content.id, 'paper.pdf', 'journal article', 1388676959000, null, ['Some author'], null, {
                            'openAccessType': 'green',
                            'journalName': 'the journal name',
                            'issueNumber': '1',
                            'pageBegin': '10',
                        ...
                        PublicationsAPI.createPublication('camtest', [ generateRandomSourceId() ], publication, function(err, publication, result) {
                            ...
                            PublicationsRestAPI.getPublication(camAdminRestCtx, publication.id, function(err, data) {
                                assert.ok(!err);
                                assert.ok(data);
                                assert.equal(data.id, publication.id);
                                assert.equal(data.displayName, publication.displayName);
                                assert.equal(data.publicationType, publication.publicationType);
                                assert.equal(data.date, publication.date);
                                assert.ok(data.linkedContent);
                                assert.equal(data.linkedContent.id, publication.linkedContentId);
                                assert.equal(data.linkedContent.displayName, publication.displayName);
                                assert.equal(data.linkedContent.createdBy, coenegoUser.user.id);
                                return callback();
                            });
                        });
                    });
        ...
        describe('#getPublicationsByAuthor()', function() {
            ...
            it('verify content profile added to publication', function(callback) {
                TestsUtil.generateTestUsers(camAdminRestCtx, 1, function(err, users, coenego) {
                    ...
                    RestAPI.Content.createFile(coenego.restContext, 'paper.pdf', null, 'public', getFileStream, null, null, function(err, content) {
                        ...
                        var publication = new Publication(null, 'camtest', coenego.user.id, content.id, 'paper.pdf', 'journal article', 1388676959000, null, authors, null, {
                            'openAccessType': 'green',
                            'journalName': 'the journal name',
                            'issueNumber': '1',
                            'pageBegin': '10',
                        ...
                        PublicationsAPI.createPublication('camtest', [ generateRandomSourceId() ], publication, function(err, publication, result) {
                            ...
                            PublicationsRestAPI.getPublicationsByAuthor(coenego.restContext, coenego.user.id, null, 50, function(err, data) {
                                ...
                                assert.equal(data.results[0].id, publication.id);
                                assert.equal(data.results[0].displayName, publication.displayName);
                                assert.equal(data.results[0].publicationType, publication.publicationType);
                                assert.equal(data.results[0].date, publication.date);
                                assert.ok(data.results[0].linkedContent);
                                assert.equal(data.results[0].linkedContent.id, publication.linkedContentId);
                                assert.equal(data.results[0].linkedContent.displayName, publication.displayName);
            ...
            it('verify a user is linked to the publication in which he was tagged as an author', function(callback) {
                TestsUtil.generateTestUsers(camAdminRestCtx, 1, function(err, users, coenego) {
                    ...
                    // Create a new publication
                    var authors = ['random user A', coenego.user.id, 'random user B'];
                    var publication = new Publication(null, 'camtest', coenego.user.id, null, 'paper.pdf', 'journal article', 1388676959000, null, authors, null, {
                        'openAccessType': 'green',
                        'journalName': 'the journal name',
                        'issueNumber': '1',
                        'pageBegin': '10',
                    ...
                    PublicationsAPI.createPublication('camtest', [ generateRandomSourceId() ], publication, function(err, publication, result) {
                        assert.ok(!err);
                        assert.equal(publication.createdBy, coenego.user.id);
                        assert.equal(result, PublicationsConstants.ingestionResult.CREATED);
                        ...
                        PublicationsRestAPI.getPublicationsByAuthor(coenego.restContext, coenego.user.id, null, null, function(err, data) {
                            ...
                            assert.equal(data.results[0].createdBy, publication.createdBy);
                            assert.equal(data.results[0].date, publication.date);
                            assert.equal(data.results[0].displayName, publication.displayName);
                            assert.equal(data.results[0].publicationType, publication.publicationType);
                            return callback();
            ...
            it('verify that the correct publications are returned when a user is tagged in multiple publications', function(callback) {
                TestsUtil.generateTestUsers(camAdminRestCtx, 1, function(err, users, coenego) {
                    ...
                    // Create a new publication
                    var publication = new Publication(null, 'camtest', coenego.user.id, null, 'displayName A', 'book', Date.now(), null, [coenego.user.id], null, {
                        'openAccessType': 'green',
                        'journalName': 'the journal name',
                        'issueNumber': '1',
                        'pageBegin': '10',
                    ...
                    PublicationsAPI.createPublication('camtest', [ generateRandomSourceId() ], publication, function(err, publication, result) {
                        ...
                        publication = new Publication(null, 'camtest', coenego.user.id, null, 'displayName B', 'book', Date.now(), null, [coenego.user.id], null, {
                            'openAccessType': 'green',
                            'journalName': 'the journal name',
                            'issueNumber': '1',
                            'pageBegin': '10',
        ...
        describe('#getPublicationsByCreator()', function() {
            ...
            it('verify a user is linked to the publication he created', function(callback) {
                TestsUtil.generateTestUsers(camAdminRestCtx, 1, function(err, users, coenego) {
                    ...
                    // Create a new publication
                    var publication = new Publication(null, 'camtest', coenego.user.id, null, 'displayName B', 'book', Date.now(), null, [coenego.user.id], null, {
                        'openAccessType': 'green',
                        'journalName': 'the journal name',
                        'issueNumber': '1',
                        'pageBegin': '10',
                    ...
                    PublicationsAPI.createPublication('camtest', [ generateRandomSourceId() ], publication, function(err, publication, result) {
                        ...
                        PublicationsRestAPI.getPublicationsByCreator(coenego.restContext, coenego.user.id, null, null, function(err, data) {
                            ...
                            assert.equal(data.results.length, 1);
                            assert.equal(data.results[0].id, publication.id);
                            assert.equal(data.results[0].authors.length, 1);
                            assert.equal(data.results[0].createdBy, publication.createdBy);
                            assert.equal(data.results[0].date, publication.date);
                            assert.equal(data.results[0].displayName, publication.displayName);
                            assert.equal(data.results[0].publicationType, publication.publicationType);
            ...
            it('verify that the correct publications are returned when creating multiple ones with the same user', function(callback) {
                TestsUtil.generateTestUsers(camAdminRestCtx, 1, function(err, users, coenego) {
                    ...
                    // Create a new publication
                    var publication = new Publication(null, 'camtest', coenego.user.id, null, 'displayName B', 'book', Date.now(), null, ['random user A'], null, {
                        'openAccessType': 'green',
                        'journalName': 'the journal name',
                        'issueNumber': '1',
                        'pageBegin': '10',
                    ...
                    PublicationsAPI.createPublication('camtest', [ generateRandomSourceId() ], publication, function(err, createdPublication1, result) {
                        assert.ok(!err);
                        assert.equal(createdPublication1.createdBy, coenego.user.id);
                        assert.equal(result, PublicationsConstants.ingestionResult.CREATED);

                        // Create a second publication
                        var publication = new Publication(null, 'camtest', coenego.user.id, null, 'displayName B', 'book', Date.now(), null, ['random user B'], null, {
                            'openAccessType': 'green',
                            'journalName': 'the journal name',
                            'issueNumber': '1',
                            'pageBegin': '10',
                        ...
                        PublicationsAPI.createPublication('camtest', [ generateRandomSourceId() ], publication, function(err, createdPublication2, result) {
                            assert.ok(!err);
                            assert.equal(createdPublication2.createdBy, coenego.user.id);
                            assert.equal(result, PublicationsConstants.ingestionResult.CREATED);
        ...
        describe('verify parameters', function() {
            ...
            it('verify that users cannot be linked twice', function(callback) {
                TestsUtil.generateTestUsers(camAdminRestCtx, 2, function(err, users, simong, mrvisser) {
                    ...
                    // Create a new publication
                    var publication = new Publication(null, 'camtest', null, null, 'displayName B', 'journal article', 1388676959000, null, ['authorA', 'authorB'], null, {
                        'openAccessType': 'green',
                        'journalName': 'the journal name',
                        'issueNumber': '1',
                        'pageBegin': '10',
            ...
            it('verify linking authors with registered oae users', function(callback) {
                TestsUtil.generateTestUsers(camAdminRestCtx, 1, function(err, users, coenego) {
                    ...
                    // Create a new publication
                    var publication = new Publication(null, 'camtest', null, null, 'displayName B', 'journal article', 1388676959000, null, ['authorA', coenego.user.id], null, {
                        'openAccessType': 'green',
                        'journalName': 'the journal name',
                        'issueNumber': '1',
                        'pageBegin': '10',
