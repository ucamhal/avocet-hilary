...
module.exports.Departments = require('./api.departments');
...
module.exports.Journals = require('./api.journals');
...
module.exports.Publications = require('./api.publications');
...
module.exports.Tickets = require('./api.tickets');
